 ...
 */
public class Level21 extends Sprite{
    ...
    public Level21(Context c, int level){
        super(c,level);
        context = c;
    }
    ...
    public void onDraw(Canvas c, float x){
        if(!levelCreated){
            ...
            walls.initializeStopAndGoStationary(20, 40);
            walls.initializeNormalMovingWall(80,35,0.3);
        ...
        walls.onDraw();
        checkSides();
        checkOrdinaryPartialWalls(walls);
        checkOrdinaryWalls();
